...
$stmt5 = $admin->ret("SELECT * FROM `category_table` where `cid`=$cid" );
            ...
            <div class="row">
                <div class="col-12">
                            ...
                            <div  >
                                <div>
                                    <div style="display: flex;flex-wrap:wrap;justify-content:center">
                                        <?php
                                        $stmt4 = $admin->ret("SELECT * FROM `product_table` INNER JOIN `category_table` ON category_table.cid=product_table.cat_id where product_table.cat_id='$cid'" );
                  ...
                  <input type="hidden" name="cqty" id="" value="1">
                      ...
                      <!-- <p>
                      <li class="add_to_cart"><button type="submit" class="btn btn-warning" name="addtocart" title="Add to Cart">Add to Cart</button></li>
                        ...
                        <div class="widgets_container widget_menu">
                            ...
                            <div class="footer_menu">
                                <ul>
                                    ...
                                    <li><a href="#">Packaging & Gift Wrapping</a></li>
