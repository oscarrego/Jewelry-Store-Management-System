...
$pid=$_GET['pid'];
 ...
 $stmt = $admin->ret("SELECT * FROM `cart_table` WHERE `p_id`='$pid' AND `user_id`='$uid'");
 ...
 $stmt2=$admin->cud("INSERT INTO `cart_table`(`p_id`,`user_id`,`cart_qty`,`cart_date`)VALUES('$pid','$uid','1',now())","saved");
 echo "<script>window.location='../cart.php';</script>";
